##=====================================================##
##        File: convert_images_filetype.py
...
rootpath_for_conversion = 'C:\\Users\\Gottfrid Olsson\\Downloads\\Bilder_DRIVE_original' # remember to write '\\' for every '\'
current_extensions = ['.tif', '.bmp'] # read about file formats: https://pillow.readthedocs.io/en/stable/handbook/image-file-formats.html
new_extension = '.jpg'
convert = False
